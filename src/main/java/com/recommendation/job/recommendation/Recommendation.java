package com.recommendation.job.recommendation;

import com.recommendation.job.db.MySQLConnection;
import com.recommendation.job.entity.Item;
import com.recommendation.job.external.GitHubClient;
...
public class Recommendation {
    public List<Item> recommendItems(String userId, double lat, double lon) {
        ...
        for (Map.Entry<String, Integer> keyword : keywordList) {
            ...
            for (Item item : items) { // 点过赞的项目不推荐 + 去重
