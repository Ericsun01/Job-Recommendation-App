package com.recommendation.job.entity;
...
@JsonIgnoreProperties(ignoreUnknown = true) // 没填上的field可以ignore,不需要必须一一对应
@JsonInclude(JsonInclude.Include.NON_NULL) // 仅显示非null的field
public class Item {
   ...
   public void setFavorite(boolean favorite) {
    ...
    public static class Builder {  //相当于可以省去constructor
        ...
        public Builder id(String id) {
            this.id = id;
            return this;
        }  // 后面build的时候可以连着调用method（分行不分号），如
        // .id();
        // .title();
        // .build();
